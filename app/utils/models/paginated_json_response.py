...
def paginated_json_response(model, url='',
                            page=1,
                            per_page=20,
                            order_by=None,
                            left_edge=2,
    ...
    return jsonify({
        'meta': {
            'pagination': {
                ...
                'page_list': [page for page in paginated.iter_pages(
                    left_edge=left_edge,
                ...
                'next_page_url': url + '?page=' + str(paginated.next_num) if paginated.has_next else None,
            }
        },
