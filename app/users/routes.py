...
users.add_url_rule(
    "/users/reset-password/<token>", view_func=ResetPassword.as_view("reset_password")
)
users.add_url_rule(
...
users.add_url_rule(
    "/users/confirm-email/<token>", view_func=ConfirmEmail.as_view("confirm_email")
)
users.add_url_rule(
    "/users/confirm-email",
...
users.add_url_rule(
    "/admin/users", view_func=AdminUsersIndex.as_view("admin_users_index")
)
users.add_url_rule(
    "/admin/users.json", view_func=AdminUsersIndexJson.as_view("admin_users_index_json")
)
