<template>
    <div>
        ...
        />
        <div v-else class="mt-6" v-html="post.body_html" />

        <div class="flex items-center mt-6">
            <fa-icon v-if="tagCount == 1" class="text-grey mr-2" :icon="['far', 'tag']"/>
            <fa-icon v-else-if="tagCount > 1" class="text-grey mr-2" :icon="['far', 'tags']"/>
