                ...
                <div class="w-full lg:w-1/3 xl:w-1/4 mt-5 lg:mt-0 px-0 lg:px-8">
                    ...
                    <div class="w-full mt-6">
                        <div>
                                                       ...
                                                       <span class="text-sm text-red-darker cursor-pointer ml-auto float-right"
                                                             v-if="publishTimeSet" @click="clearPublishedAt()">
                        ...
                        <label class="w-full block text-grey cursor-pointer flex mb-2" v-if="! publishTimeSet">
                            <input class="mr-2 leading-tight" type="checkbox" v-model="setPublishTimeManually">
                            <span class="text-sm">
