        ...
        >
            ...
            <div class="block xl:flex mt-6">
                <div class="w-full p-3 xl:w-2/3 ">
                    ...
                    <div class="w-full" v-if="publishedInPast">
                        <label
                                class="text-input-label"
                                for="grid-url"
                        >
                    ...
                    <div class="w-full mt-4">
                        <image-upload-collection parent-type="post"
                ...
                <div class="w-full xl:w-1/3 mt-5 xl:mt-0 p-3">
                    ...
                    <div class="mt-10">
                        <image-primary parent-type="post" :image="primaryImage"/>
                    </div>
                </div>
            </div>
            <modal
        ...
        methods: {
            ...
            postLoad(savedPost) {
                ...
                if (this.savedPost.primary_image) {
                    const primary_image_id = this.savedPost.primary_image.id
